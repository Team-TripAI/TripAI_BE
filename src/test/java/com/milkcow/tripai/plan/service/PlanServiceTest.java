...
class PlanServiceTest {
    ...
    public void 일정_조회() throws Exception{
        ...
        //when
        PlanDto planDto = planService.find(member, id);
        //then
    ...
    private static PlanDto getPlanDto(){
        AccommodationPlan accommodationPlan = AccommodationPlan.builder()
                .name("Lodging Tokyo Ueno")
                .lat(35.7176401814438)
                .lng(139.785188392868)
                .startDate(LocalDate.of(2023,12,25))
        ...
        FlightPlan flightPlan = FlightPlan.builder()
                ...
                .departure("ICN")
                .arrival("LAX")
                .startTime(LocalDateTime.of(2023,12,25,13,30))
                .endTime(LocalDateTime.of(2023,12,25,7,20))
                ...
                .build();
        RestaurantPlan restaurantPlan = RestaurantPlan.builder()
        ...
        return PlanDto.builder()
                ...
                .restaurant(30)
                .attraction(10)
                .accommodationList(List.of(accommodationPlan))
                .flightList(List.of(flightPlan))
                .restaurantList(List.of(restaurantPlan))
                .attractionList(List.of(attractionPlan))
                .build();
    }

...
import com.milkcow.tripai.plan.service.AccommodationPlanService;
...
public class PlanController {
    ...
    private final AccommodationPlanService accommodationPlanService;
    ...
    public DataResponse<FlightDataDto> getFlightPlan(@RequestParam String departureAirport,
        ...
        FlightDataDto flightData = flightPlanService.getFlightData(departureAirport, arrivalAirport, departure,
                maxFare);
